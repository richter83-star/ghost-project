...
function getDracanusCSS(): string {
  return `/* DRACANUS AI - PREMIUM DARK THEME */
:root {
...
html, body { background: var(--dracanus-darkest) !important; color: var(--dracanus-text) !important; font-family: 'Inter', -apple-system, sans-serif !important; }
.main-content, main, #MainContent, .shopify-section { background: var(--dracanus-darkest) !important; }
header, .header, .site-header, .header-wrapper, #shopify-section-header { background: linear-gradient(135deg, #0a0a0f 0%, #121218 50%, #1e2530 100%) !important; border-bottom: 1px solid var(--dracanus-border) !important; box-shadow: 0 2px 20px rgba(0, 0, 0, 0.5) !important; }
.header__menu-item, nav a, .site-nav a, .header-menu-item { color: var(--dracanus-silver) !important; font-weight: 500 !important; letter-spacing: 0.5px !important; text-transform: uppercase !important; font-size: 13px !important; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important; }
.header__menu-item:hover, nav a:hover, .site-nav a:hover { color: var(--dracanus-cyan) !important; text-shadow: 0 0 10px var(--dracanus-cyan) !important; }
.product-card, .card, .product-item, .grid__item .card { background: var(--dracanus-surface) !important; border: 1px solid var(--dracanus-border) !important; border-radius: 4px !important; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1) !important; }
.product-card:hover, .card:hover { transform: translateY(-8px) !important; border-color: var(--dracanus-cyan) !important; box-shadow: var(--dracanus-glow), var(--dracanus-shadow) !important; }
.product-card__title, .card__heading, .product-title, h3.card__heading a { color: var(--dracanus-light-silver) !important; font-weight: 600 !important; }
.price, .product-price, .price__regular, .money { color: var(--dracanus-cyan) !important; font-weight: 700 !important; }
.btn, button, .button, .shopify-payment-button__button, input[type="submit"] { background: linear-gradient(135deg, #1e2530, #2d3748) !important; color: var(--dracanus-light-silver) !important; border: 1px solid var(--dracanus-silver) !important; border-radius: 2px !important; font-weight: 600 !important; letter-spacing: 1px !important; text-transform: uppercase !important; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important; }
.btn:hover, button:hover, .button:hover { background: linear-gradient(135deg, #2d3748, #06b6d4) !important; border-color: var(--dracanus-cyan) !important; box-shadow: var(--dracanus-glow) !important; transform: translateY(-2px) !important; }
.btn--primary, .product-form__submit, .cart__submit { background: linear-gradient(135deg, #06b6d4, #8b5cf6) !important; border: none !important; color: white !important; }
.btn--primary:hover, .product-form__submit:hover { background: linear-gradient(135deg, #8b5cf6, #06b6d4) !important; box-shadow: 0 0 30px var(--dracanus-cyan) !important; }
footer, .footer, .site-footer, #shopify-section-footer { background: var(--dracanus-darkest) !important; border-top: 1px solid var(--dracanus-border) !important; }
footer a, .footer a { color: var(--dracanus-silver) !important; }
footer a:hover, .footer a:hover { color: var(--dracanus-cyan) !important; }
.product__title, .product-single__title { color: var(--dracanus-light-silver) !important; font-size: 2.5rem !important; font-weight: 700 !important; }
.collection-hero { background: linear-gradient(135deg, #0a0a0f 0%, #121218 50%, #1e2530 100%) !important; }
.collection-hero__title { color: var(--dracanus-light-silver) !important; font-size: 3rem !important; font-weight: 800 !important; text-transform: uppercase !important; }
input, textarea, select, .field__input { background: var(--dracanus-surface) !important; border: 1px solid var(--dracanus-border) !important; color: var(--dracanus-text) !important; border-radius: 2px !important; }
input:focus, textarea:focus, select:focus { border-color: var(--dracanus-cyan) !important; box-shadow: 0 0 10px #06b6d440 !important; }
h1, h2, h3, h4, h5, h6 { color: var(--dracanus-light-silver) !important; font-weight: 700 !important; }
a { color: var(--dracanus-cyan) !important; transition: all 0.3s ease !important; }
a:hover { color: var(--dracanus-purple) !important; text-shadow: 0 0 8px var(--dracanus-cyan) !important; }
::-webkit-scrollbar { width: 8px !important; }
::-webkit-scrollbar-track { background: var(--dracanus-darkest) !important; }
::-webkit-scrollbar-thumb { background: var(--dracanus-charcoal) !important; border-radius: 4px !important; }
::-webkit-scrollbar-thumb:hover { background: var(--dracanus-silver) !important; }
.announcement-bar { background: linear-gradient(90deg, #0a0a0f, #1e2530, #0a0a0f) !important; border-bottom: 1px solid #06b6d440 !important; color: var(--dracanus-silver) !important; }`;
}
